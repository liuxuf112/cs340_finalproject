...
INSERT INTO `BookList` (`Book_ID`, `Book_name`, `Category`, `Owner_ID`, `On_Sell`) VALUES
(1, 'Harry Potter', 'fantasy', 1, -1),
(2, 'Bible', 'god', 3, -1),
(3, 'Financial Crises', 'economy', 2, 1),
(4, 'Analysing Qualitative Data in Psychology', 'psychology', 1, -1),
(5, 'Headway Academic Skills: Reading, Writing', 'English', 1, 1);
